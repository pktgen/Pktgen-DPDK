...
#define lua_putstring(L, s)        (fwrite((s), sizeof(char), strlen(s), _get_stdout(L)), fflush(_get_stdout(L)))
#define lua_writestring(_L, s,l)   (fwrite((s), sizeof(char), (l), _get_stdout(_L)), fflush(_get_stdout(L)))
#define lua_writeline(_L)  (lua_writestring(_L, "\n", 1), fflush(_get_stdout(_L)))
#endif
...
#define lua_writestringerror(_L, s, p) \
