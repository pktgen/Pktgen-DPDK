...
./app/app/${target}/pktgen -c ff004 -n 3 --proc-type auto --log-level 0 --socket-mem 512,512 --file-prefix pg2 -b 09:00.0 -b 09:00.1 -b 06:00.0 -b 06:00.1 -b 08:00.0 -b 08:00.1 -- -T -P -m "[12:16].0, [13:17].1, [14:18].2, [15:19].3" -f themes/black-yellow.theme
fi
